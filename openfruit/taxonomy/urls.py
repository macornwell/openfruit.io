...
from openfruit.taxonomy.views import GenusListView, KingdomListView, \
    ...
    move_fruiting_plant, FruitingPlantFormView, Cultivar, SpeciesFormView
...
urlpatterns = [
    ...
    url(r'^api/v1/fruiting-plants/(?P<query>.+)?$', views.UsersPlantsListView.as_view(), name='users-fruiting-plants'),
]
